...
func (os *hotelService) HandleGetHotelPreviews(ctx context.Context, filter bookly.HotelFilter) ([]*bookly.HotelListing, error) {
...
func (os *hotelService) HandleGetHotelDetails(ctx context.Context, hotelID int64) (*bookly.Hotel, error) {
